# Mastishk — Claude Code Instructions

## Project Identity

**Mastishk** (Sanskrit: मस्तिष्क — brain) — Computational neuroscience engine: neurotransmitter dynamics, neural circuits, sleep architecture, HPA axis, default mode network, chronobiology
...
bhava (emotion/personality), bodh (psychology/cognition), kiran (game engine), joshua (agent characters), agnosai (agent orchestration)
